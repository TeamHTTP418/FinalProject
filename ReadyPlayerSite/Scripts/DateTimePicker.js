//Original Author: Andy Edinborough @ http://edinborough.org/Duck-Punching-jQuery-UI-Datepicker-into-a-DateTimepicker
...
(function ($, undefined) {
    ...
    $.datepicker._updateDatepicker = /*overrides*/function (inst) {
        ...
        if (showTime) {
            ...
            divHour.slider({
                min: 0, max: 23, value: inst.selectedHour, orientation: 'vertical', slide: function (e, ui) {
            ...
            divMin.slider({
                min: 0, max: 59, value: inst.selectedMinute, orientation: 'vertical', slide: function (e, ui) {
...
var options = {
    buttons: {
        'Cancel': {
            css: { 'float': 'right' }, click: function (sel, inst) {
